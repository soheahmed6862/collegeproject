import { geterror, getfailerState, getProductState, getProductSuccessState, getState, productsuccess } from "./productReux"
...
export const getproduct=async(dispatch)=>{
   ...
   console.log(  dispatch(getProductSuccessState(product.data)))
