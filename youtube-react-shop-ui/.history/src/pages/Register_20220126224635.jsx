  ...
  return (
    <Container>
      <Wrapper>
        ...
        <Form >
          <Input placeholder="name" type="text" name="name" value={input} onChange={(e)=>setInput()} required/>
         
          <Input type="mail" placeholder="email"value={input} onChange={(e)=>setInput()}  required/>
         
  
           
          <Input type="password" placeholder="password" value={input} onChange={(e)=>setInput()} required/>
